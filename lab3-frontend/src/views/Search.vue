                  ...
                  <div style="padding: 14px">
                    ...
                    <div class="bottom clearfix">
                      ...
                      <el-button
                        type="warning"
                        class="button"
                        v-on:click="handleFavorites($event, item)"
  ...
  export default {
    ...
    methods: {
      ...
      handleSuccess(response, file, fileList) {
        ...
        console.log("imageList before = ", this.imageList)
        for (let i = 0; i < this.imageList.length; i++) {
          this.imageList[i] = `http://127.0.0.1:5000${this.imageList[i].replace(/\\/g, "/")}`;
        }
        console.log("imageList after = ", this.imageList)
        this.file = file
